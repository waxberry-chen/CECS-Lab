module SegReg_LS_WB#(
    ...
    input  logic [ 0:0] exp_ecall_ls,
    input  logic [ 0:0] exp_mret_ls,
    ...
    output logic [ 0:0] exp_ecall_wb,
    output logic [ 0:0] exp_mret_wb,
    ...
    always_ff @(posedge clk) begin
        if(!rstn || flush) begin
            ...
            exp_ecall_wb    <= exp_ecall_ls;
            exp_mret_wb     <= exp_mret_ls;
            commit_wb       <= commit_ls;
